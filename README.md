...
- Установка плагина vidIQ в Codex как часть готового установочного промпта.
...
В Codex установочный мастер также открывает штатное подтверждение установки vidIQ. Подключение аккаунта подтверждается пользователем в интерфейсе; Watch не получает и не хранит пароль vidIQ.
