...
Не публикуй содержимое `.env`. В конце кратко перечисли выбранный режим транскрипции, режим анализа, статус Apify, выбранный адаптер vidIQ и наличие реальных vidIQ tools, но не значения секретов.
