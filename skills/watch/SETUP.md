...
## 5. Установить vidIQ в Codex

vidIQ дополняет Watch данными YouTube: аналитикой канала, ключевыми словами и конкурентными сигналами. В Codex используй штатный интерфейс установки плагинов и предложи установить точный плагин:

```text
vidIQ (app-69dd11f3e50c8191b1ca48d03cf7e2ad@openai-curated-remote)
```

Если пользователь запустил готовый промпт из `INSTALL_PROMPT.md`, установка vidIQ уже входит в его запрос: сразу открой штатное подтверждение установки. В остальных случаях сначала спроси согласие. Пользователь всё равно должен подтвердить установку и при необходимости подключить аккаунт в интерфейсе Codex — не обходи это подтверждение и не проси пароль в чате.
...
В Claude Code этот Codex-плагин автоматически не устанавливается. Сам Watch при этом работает нормально.
...
Не публикуй содержимое `.env`. В конце кратко перечисли выбранный режим транскрипции, режим анализа, статус Apify и статус vidIQ, но не значения секретов.
